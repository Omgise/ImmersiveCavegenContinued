...
{
    public List<Type> targetMethodArguments;
    public List<Integer> transmittableVariableIndexes;
    public List<Type> fixMethodArguments;
    public Type fixMethodReturnType;
    public Type targetMethodReturnType;
    public FixOrder priority;
    EnumReturnType EnumReturnType;
    EnumReturnSetting EnumReturnSetting;
    public FixInserterFactory injectorFactory;
    public static final FixInserterFactory ON_ENTER_FACTORY;
    public static final FixInserterFactory ON_EXIT_FACTORY;
    ...
    public ASMFix() {
        this.targetMethodArguments = new ArrayList<Type>(2);
        this.transmittableVariableIndexes = new ArrayList<Integer>(2);
        this.fixMethodArguments = new ArrayList<Type>(2);
        this.fixMethodReturnType = Type.VOID_TYPE;
        this.priority = FixOrder.USUAL;
        this.EnumReturnType = net.tclproject.mysteriumlib.asm.annotations.EnumReturnType.VOID;
        this.EnumReturnSetting = net.tclproject.mysteriumlib.asm.annotations.EnumReturnSetting.NEVER;
        this.injectorFactory = ASMFix.ON_ENTER_FACTORY;
    }
    ...
    public boolean isTheTarget(final String name, final String descriptor) {
        return ((this.targetMethodReturnType == null && descriptor.startsWith(this.targetMethodDescriptor)) || descriptor.equals(this.targetMethodDescriptor)) && name.equals(this.targetMethodName);
    }
    ...
    public void createMethod(final FixInserterClassVisitor classVisitor) {
        final MetaReader.MethodReference superMethod = classVisitor.transformer.metaReader.findMethod(this.getTargetClassInternalName(), this.targetMethodName, this.targetMethodDescriptor);
        final MethodVisitor methodVisitor = classVisitor.visitMethod(1, (superMethod == null) ? this.targetMethodName : superMethod.name, this.targetMethodDescriptor, null, null);
        if (methodVisitor instanceof FixInserter) {
            final FixInserter inserter = (FixInserter)methodVisitor;
            inserter.visitCode();
    ...
    public void insertFix(final FixInserter inserter) {
        final Type targetMethodReturnType = inserter.methodType.getReturnType();
        ...
        if (this.hasFixMethod()) {
            this.insertInvokeStatic(inserter, returnLocalIndex, this.fixMethodName, this.fixMethodDescriptor);
            final EnumReturnType enumReturnType = this.EnumReturnType;
            final EnumReturnType enumReturnType2 = this.EnumReturnType;
            if (enumReturnType == net.tclproject.mysteriumlib.asm.annotations.EnumReturnType.FIX_METHOD_RETURN_VALUE || this.EnumReturnSetting.conditionRequiredToReturn) {
        ...
        final EnumReturnSetting enumReturnSetting = this.EnumReturnSetting;
        final EnumReturnSetting enumReturnSetting2 = this.EnumReturnSetting;
        if (enumReturnSetting != net.tclproject.mysteriumlib.asm.annotations.EnumReturnSetting.NEVER) {
            final Label label = inserter.newLabel();
            final EnumReturnSetting enumReturnSetting3 = this.EnumReturnSetting;
            final EnumReturnSetting enumReturnSetting4 = this.EnumReturnSetting;
            if (enumReturnSetting3 != net.tclproject.mysteriumlib.asm.annotations.EnumReturnSetting.ALWAYS) {
                inserter.visitVarInsn(this.fixMethodReturnType.getOpcode(21), fixResultLocalIndex);
                final EnumReturnSetting enumReturnSetting5 = this.EnumReturnSetting;
                final EnumReturnSetting enumReturnSetting6 = this.EnumReturnSetting;
                if (enumReturnSetting5 == net.tclproject.mysteriumlib.asm.annotations.EnumReturnSetting.ON_TRUE) {
                    inserter.visitJumpInsn(153, label);
                }
                else {
                    final EnumReturnSetting enumReturnSetting7 = this.EnumReturnSetting;
                    final EnumReturnSetting enumReturnSetting8 = this.EnumReturnSetting;
                    if (enumReturnSetting7 == net.tclproject.mysteriumlib.asm.annotations.EnumReturnSetting.ON_NULL) {
                        inserter.visitJumpInsn(199, label);
                    }
                    else {
                        final EnumReturnSetting enumReturnSetting9 = this.EnumReturnSetting;
                        final EnumReturnSetting enumReturnSetting10 = this.EnumReturnSetting;
                        if (enumReturnSetting9 == net.tclproject.mysteriumlib.asm.annotations.EnumReturnSetting.ON_NOT_NULL) {
                            inserter.visitJumpInsn(198, label);
                        }
                    }
                }
            }
            final EnumReturnType enumReturnType3 = this.EnumReturnType;
            final EnumReturnType enumReturnType4 = this.EnumReturnType;
            if (enumReturnType3 == net.tclproject.mysteriumlib.asm.annotations.EnumReturnType.NULL) {
                inserter.visitInsn(1);
            }
            else {
                final EnumReturnType enumReturnType5 = this.EnumReturnType;
                final EnumReturnType enumReturnType6 = this.EnumReturnType;
                if (enumReturnType5 == net.tclproject.mysteriumlib.asm.annotations.EnumReturnType.PRIMITIVE_CONSTANT) {
                    inserter.visitLdcInsn(this.primitiveAlwaysReturned);
                }
                else {
                    final EnumReturnType enumReturnType7 = this.EnumReturnType;
                    final EnumReturnType enumReturnType8 = this.EnumReturnType;
                    if (enumReturnType7 == net.tclproject.mysteriumlib.asm.annotations.EnumReturnType.FIX_METHOD_RETURN_VALUE) {
                        inserter.visitVarInsn(this.fixMethodReturnType.getOpcode(21), fixResultLocalIndex);
                    }
                    else {
                        final EnumReturnType enumReturnType9 = this.EnumReturnType;
                        final EnumReturnType enumReturnType10 = this.EnumReturnType;
                        if (enumReturnType9 == net.tclproject.mysteriumlib.asm.annotations.EnumReturnType.ANOTHER_METHOD_RETURN_VALUE) {
                            ...
                            this.insertInvokeStatic(inserter, returnLocalIndex, this.returnMethodName, returnMethodDescription);
                        }
                    }
                }
            }
    ...
    public void insertLoad(final FixInserter inserter, final Type parameterType, final int variableIndex) {
        int opcode;
    ...
    public void insertSuperCall(final FixInserter inserter, final MetaReader.MethodReference method) {
        int variableIndex = 0;
        for (int i = 0; i <= this.targetMethodArguments.size(); ++i) {
            final Type argumentType = (i == 0) ? TypeUtils.getType(this.targetClassName) : this.targetMethodArguments.get(i - 1);
    ...
    public void insertPushDefaultReturnValue(final FixInserter inserter, final Type targetMethodReturnType) {
    ...
    public void insertReturn(final FixInserter inserter, final Type targetMethodReturnType) {
    ...
    public void insertInvokeStatic(final FixInserter inserter, final int indexOfReturnArgument, final String name, final String descriptor) {
        for (int i = 0; i < this.fixMethodArguments.size(); ++i) {
            final Type parameterType = this.fixMethodArguments.get(i);
    ...
    @Override
    public int compareTo(final ASMFix fix) {
    ...
    static {
        ON_ENTER_FACTORY = FixInserterFactory.OnEnter.INSTANCE;
        ON_EXIT_FACTORY = FixInserterFactory.OnExit.INSTANCE;
    }
    ...
    public class Builder extends ASMFix
    {
        ...
        public Builder setTargetClass(final String name) {
            ASMFix.this.targetClassName = name;
            return this;
        }

        public Builder setTargetMethod(final String name) {
            ASMFix.this.targetMethodName = name;
            return this;
        }

        public Builder addTargetMethodParameters(final Type... argumentTypes) {
        ...
        public Builder addTargetMethodParameters(final String... argumentTypeNames) {
            final Type[] types = new Type[argumentTypeNames.length];
        ...
        public Builder setFixesClass(final String name) {
            ASMFix.this.classWithFixes = name;
            return this;
        }

        public Builder setFixMethod(final String name) {
            ASMFix.this.fixMethodName = name;
            return this;
        }

        public Builder addFixMethodParameter(final Type parameterType, final int variableIndex) {
        ...
        public Builder addFixMethodParameter(final String parameterTypeName, final int variableIndex) {
        ...
        public Builder setReturnSetting(final EnumReturnSetting setting) {
        ...
        public Builder setReturnType(final EnumReturnType type) {
            this.classWithFixes = ASMFix.this.classWithFixes;
            this.fixMethodName = ASMFix.this.fixMethodName;
            final EnumReturnSetting enumReturnSetting = ASMFix.this.EnumReturnSetting;
            final EnumReturnSetting enumReturnSetting2 = this.EnumReturnSetting;
            if (enumReturnSetting == net.tclproject.mysteriumlib.asm.annotations.EnumReturnSetting.NEVER) {
                throw new IllegalStateException("Current return condition is never, so it does not make sense to specify the return value.");
            }
            final Type returnType = ASMFix.this.targetMethodReturnType;
            final EnumReturnType enumReturnType = this.EnumReturnType;
            if (type != net.tclproject.mysteriumlib.asm.annotations.EnumReturnType.VOID && returnType == Type.VOID_TYPE) {
            ...
            final EnumReturnType enumReturnType3 = this.EnumReturnType;
            if (type == net.tclproject.mysteriumlib.asm.annotations.EnumReturnType.PRIMITIVE_CONSTANT && returnType != null && !this.isPrimitive(returnType)) {
                throw new IllegalArgumentException("Target method return type isn't a primitive, so it is impossible to return one.");
            }
            final EnumReturnType enumReturnType4 = this.EnumReturnType;
            if (type == net.tclproject.mysteriumlib.asm.annotations.EnumReturnType.NULL && returnType != null && this.isPrimitive(returnType)) {
                throw new IllegalArgumentException("Target method return type is a primitive, so it is impossible to return null.");
            }
            final EnumReturnType enumReturnType5 = this.EnumReturnType;
            if (type == net.tclproject.mysteriumlib.asm.annotations.EnumReturnType.FIX_METHOD_RETURN_VALUE && !this.hasFixMethod()) {
        ...
        public void setFixMethodReturnType(final Type type) {
        ...
        public Builder setPrimitiveAlwaysReturned(final Object object) {
            final EnumReturnType enumReturnType = ASMFix.this.EnumReturnType;
            final EnumReturnType enumReturnType2 = this.EnumReturnType;
            if (enumReturnType != net.tclproject.mysteriumlib.asm.annotations.EnumReturnType.PRIMITIVE_CONSTANT) {
                throw new IllegalStateException("Return type is not PRIMITIVE_CONSTANT, so it doesn't make sense to specify that constant.");
            }
            final Type returnType = ASMFix.this.targetMethodReturnType;
            if ((returnType == Type.BOOLEAN_TYPE && !(object instanceof Boolean)) || (returnType == Type.CHAR_TYPE && !(object instanceof Character)) || (returnType == Type.BYTE_TYPE && !(object instanceof Byte)) || (returnType == Type.SHORT_TYPE && !(object instanceof Short)) || (returnType == Type.INT_TYPE && !(object instanceof Integer)) || (returnType == Type.LONG_TYPE && !(object instanceof Long)) || (returnType == Type.FLOAT_TYPE && !(object instanceof Float)) || (returnType == Type.DOUBLE_TYPE && !(object instanceof Double))) {
        ...
        public Builder setReturnMethod(final String name) {
            final EnumReturnType enumReturnType = ASMFix.this.EnumReturnType;
            final EnumReturnType enumReturnType2 = this.EnumReturnType;
            if (enumReturnType != net.tclproject.mysteriumlib.asm.annotations.EnumReturnType.ANOTHER_METHOD_RETURN_VALUE) {
        ...
        public Builder setInjectorFactory(final FixInserterFactory factory) {
            ASMFix.this.injectorFactory = factory;
            return this;
        }

        public Builder setPriority(final FixOrder priority) {
            ASMFix.this.priority = priority;
            return this;
        }

        public Builder setCreateMethod(final boolean createMethod) {
            ASMFix.this.createMethod = createMethod;
            return this;
        }

        public Builder setFatal(final boolean isMandatory) {
            ASMFix.this.isFatal = isMandatory;
            return this;
        }

        private String getMethodDescriptor(final Type returnType, final List<Type> argumentTypes) {
            final Type[] paramTypesArray = argumentTypes.toArray(new Type[0]);
            if (returnType == null) {
                final String voidDescriptor = Type.getMethodDescriptor(Type.VOID_TYPE, paramTypesArray);
        ...
        public ASMFix build() {
            ...
            fix.targetMethodDescriptor = this.getMethodDescriptor(fix.targetMethodReturnType, fix.targetMethodArguments);
            if (fix.hasFixMethod()) {
                fix.fixMethodDescriptor = Type.getMethodDescriptor(fix.fixMethodReturnType, (Type[])fix.fixMethodArguments.toArray(new Type[0]));
            }
            final EnumReturnType enumReturnType = fix.EnumReturnType;
            final EnumReturnType enumReturnType2 = this.EnumReturnType;
            if (enumReturnType == net.tclproject.mysteriumlib.asm.annotations.EnumReturnType.ANOTHER_METHOD_RETURN_VALUE) {
                fix.returnMethodDescriptor = this.getMethodDescriptor(fix.targetMethodReturnType, fix.fixMethodArguments);
            }
            try {
                fix = (ASMFix)Object.this.clone();
            }
            ...
            final EnumReturnType enumReturnType3 = fix.EnumReturnType;
            final EnumReturnType enumReturnType4 = this.EnumReturnType;
            if (enumReturnType3 == net.tclproject.mysteriumlib.asm.annotations.EnumReturnType.PRIMITIVE_CONSTANT && fix.primitiveAlwaysReturned == null) {
            ...
            final EnumReturnType enumReturnType5 = fix.EnumReturnType;
            final EnumReturnType enumReturnType6 = this.EnumReturnType;
            if (enumReturnType5 == net.tclproject.mysteriumlib.asm.annotations.EnumReturnType.ANOTHER_METHOD_RETURN_VALUE && fix.returnMethodName == null) {
            ...
            if (!(fix.injectorFactory instanceof FixInserterFactory.OnExit) && fix.hasReturnedValueParameter) {
