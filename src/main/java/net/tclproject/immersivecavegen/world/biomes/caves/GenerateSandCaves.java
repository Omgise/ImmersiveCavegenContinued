...
public final class GenerateSandCaves extends WorldGenerator
{
    public boolean func_76484_a(final World world, final Random random, final int x, final int y, final int z) {
        switch (CavesDecorator.weightedChoice(WGConfig.scaveslist)) {
            case 1: {
                new GenerateSandstoneStalactites().generate(world, random, x, y, z, CavesDecorator.getNumEmptyBlocks(world, x, y, z), 8);
