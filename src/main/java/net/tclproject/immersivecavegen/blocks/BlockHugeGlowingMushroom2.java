...
public class BlockHugeGlowingMushroom2 extends BlockHugeMushroom
{
    ...
    public BlockHugeGlowingMushroom2(final Material p_i45412_1_, final int p_i45412_2_) {
        super(p_i45412_1_, p_i45412_2_);
        this.rand = new Random();
        this.field_149792_b = p_i45412_2_;
        this.func_149711_c(0.2f).func_149672_a(BlockHugeGlowingMushroom2.field_149766_f).func_149713_g(3).func_149663_c("mushroom").func_149658_d("immersivecavegen:mushroom_block").func_149715_a(0.4f);
    }
    ...
    public Item func_149694_d(final World p_149694_1_, final int p_149694_2_, final int p_149694_3_, final int p_149694_4_) {
        return Item.func_150899_d(Block.func_149682_b(BlockInit.mushroomBlockGreen) + this.field_149792_b);
    }
    ...
    public void func_149651_a(final IIconRegister p_149651_1_) {
        this.field_149794_M = new IIcon[BlockHugeGlowingMushroom2.field_149793_a.length];
        for (int i = 0; i < this.field_149794_M.length; ++i) {
            this.field_149794_M[i] = p_149651_1_.func_94245_a(this.func_149641_N() + "_" + BlockHugeGlowingMushroom2.field_149793_a[i]);
        }
        this.field_149796_O = p_149651_1_.func_94245_a(this.func_149641_N() + "_inside2");
        this.field_149795_N = p_149651_1_.func_94245_a(this.func_149641_N() + "_skin_stem2");
    }
